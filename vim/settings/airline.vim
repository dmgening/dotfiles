...
let g:airline#themes#swayr#palette.replace = airline#themes#generate_color_map(s:R1, s:I2, s:I3)
let g:airline#themes#swayr#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)

let g:airline#themes#swayr#palette.normal_modified = {'airline_c': ['#ffffff', '#5f005f', 15, 8, ''],}
...
let g:airline#themes#swayr#palette.visual_modified = {'airline_c': ['#ffffff', '#5f005f', 15, 8, ''],}
