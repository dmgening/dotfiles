...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("TabLineSel", s:orange, s:background, "NONE")
	call <SID>X("TabLineFill", s:background, s:background, "NONE")
	...
	if version >= 700
		...
		call <SID>X("SignColumn", s:foreground, s:background, "NONE")
	end
	if version >= 703
	...
	call <SID>X("SyntasticStyleErrorSign", s:purple, "", "")
	call <SID>X("SyntasticStyleWariningSign", s:orange, "", "")
	...
	" Diff Highlighting
	call <SID>X("DiffAdd", "", s:background, "")
	call <SID>X("DiffChange", "", s:background, "")
	call <SID>X("DiffDelete", "", s:background, "")
	call <SID>X("DiffText", "", s:background, "")
